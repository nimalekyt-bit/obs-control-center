...
[Скачать Early Access](https://github.com/nimalekyt-bit/obs-control-center/releases/tag/v0.13.0) · [Сообщить об ошибке](https://github.com/nimalekyt-bit/obs-control-center/issues) · [Документация](https://obscontrol.center/docs/)
